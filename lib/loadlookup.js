...
exports.asyncAll = function (cb) {
  async.parallel({
    tmsConsituentsLookup: (callback) => {
      exports.tmsConsituentsLookup((lookupDate) => {
        callback(null, lookupDate)
      })
    },
    tmsTitlesLookup: (callback) => {
      exports.tmsTitlesLookup((lookupDate) => {
        callback(null, lookupDate)
      })
    },
    tmsAltNumLookup: (callback) => {
      exports.tmsAltNumLookup((lookupDate) => {
        callback(null, lookupDate)
      })
    },
    tmsObjConXrefLookup: (callback) => {
      exports.tmsObjConXrefLookup((lookupDate) => {
        callback(null, lookupDate)
      })
    },
    tmsDepartmentsLookup: (callback) => {
      exports.tmsDepartmentsLookup((lookupDate) => {
        callback(null, lookupDate)
      })
    },
    tmsClassificationLookup: (callback) => {
      exports.tmsClassificationLookup((lookupDate) => {
        callback(null, lookupDate)
      })
    }
